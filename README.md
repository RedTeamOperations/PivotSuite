...
PivotSuite as a Server: If the Compromised host is directly accessable (Forward Connection) from Our pentest machine,
...
PivotSuite as a Client: If the Compromised host is behind a Firewall / NAT and isn't directly accessable from our 
...
----------------------------------------------------------------------------------------------------------------------------
How to Use PivotSute:

Usage: pivotsuite.py [options] SERVER-IP SERVER-PORT
...
1.) Scenerio A: (Forward TCP Tunneling)
...
2.) Scenerio B: (Reverse TCP Tunneling)
